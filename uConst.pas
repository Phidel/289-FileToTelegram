...
const
  ...
  cdot_symbol = '∙'; { Alt+249 }
  middle_dot = '·'; { MIDDLE DOT = interpoint = interpunct = centered dot &middot; &centerdot; &#183; Alt+0183 Alt+250 }
  bullet = '•'; { &bullet; &bull; &#149; жирная точка Alt+7 или Alt+0149}
  white_bullet = '◦'; { WHITE BULLET }
  white_circle = '○'; { WHITE CIRCLE &cir;}
  black_circle = '●'; { BLACK CIRCLE}
  
  ellipsis_symbol = '…';
  multiplication_sign = '×';
  reference_sign = '※'; { REFERENCE MARK }
  degree_symbol = '&#176;'; { знак градуса Alt+248 °}
  plus_minus_symbol = '&#177;'; { плюс-минус ± }
  CR = #13#10;
